...
terminals = [
    ...
    "*"
    # ,
    # #we want to add the action symbols which begin with '#' in the rules dictionary to the terminals list
    # "#call_main",
    # "#p_type",
    # "#declare_id",
    # "#dec_var",
...
# now we want a version of rules that all the action symbols are removed
rules = {
    'Program': [['Declaration-list']],
    'Declaration-list': [['Declaration', 'Declaration-list'], ['epsilon']],
    'Declaration': [['Declaration-initial', 'Declaration-prime']],
